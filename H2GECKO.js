 ...
 const getCurrentTime = () => {
  ...
  Promise.race([axiosPromise, timeoutPromise])
    .then((response) => {
      ...
      console.log(`[\x1b[Sky Cat\x1b[0m] ${getCurrentTime()} Title: ${getTitleFromHTML(data)} (\x1b[32m${status}\x1b[0m)`);
    })
    .catch((error) => {
      if (error.message === 'Request timed out') {
        ...
        console.log(`[\x1b[35mSky Cat\x1b[0m] ${getCurrentTime()} Title: ${extractedTitle} (\x1b[31m${error.response.status}\x1b[0m)`);
      } else {
        console.log(`[\x1b[35mSky Cat\x1b[0m] ${getCurrentTime()} ${error.message}`);
      }
    });
}
...
if (cluster.isMaster){
  console.clear();
  console.log(`Bypass Methods By @Xyran16
`);
